...
pub const LC_OPT_FPGA_TLP_READ_CB_BACKGROUND_THREAD: u64 = 216173409179009024;
pub const LC_CMD_FPGA_WRITE_TLP: u64 = 1103806595072;
pub const LC_CMD_FPGA_LISTEN_TLP: u64 = 1108101562368;
...
pub const LC_CMD_FPGA_TLP_READ_FUNCTION_CALLBACK: u64 = 1181116006400;
...
pub type LPCSTR = *mut ::std::os::raw::c_char;
pub type WCHAR = u16;
...
extern "C" {
    pub fn LcClose(hLC: HANDLE) -> VOID;
}
#[repr(C)]
#[derive(Copy, Clone)]
...
extern "C" {
    pub fn LcMemFree(pv: PVOID) -> VOID;
}
extern "C" {
...
extern "C" {
    pub fn LcReadScatter(hLC: HANDLE, cMEMs: DWORD, ppMEMs: PPMEM_SCATTER) -> VOID;
}
extern "C" {
    pub fn LcRead(hLC: HANDLE, pa: QWORD, cb: DWORD, pb: PBYTE) -> BOOL;
}
extern "C" {
    pub fn LcWriteScatter(hLC: HANDLE, cMEMs: DWORD, ppMEMs: PPMEM_SCATTER) -> VOID;
}
extern "C" {
...
pub type PLC_TLP_READ_FUNCTION_CALLBACK = ::std::option::Option<
    unsafe extern "C" fn(
        ctx: PVOID,
        cbTlp: DWORD,
        pbTlp: PBYTE,
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct tdLC_TLP_CALLBACK {
    pub ctx: PVOID,
    pub pfn: PLC_TLP_READ_FUNCTION_CALLBACK,
}
#[test]
fn bindgen_test_layout_tdLC_TLP_CALLBACK() {
    const UNINIT: ::std::mem::MaybeUninit<tdLC_TLP_CALLBACK> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<tdLC_TLP_CALLBACK>(),
        16usize,
        concat!("Size of: ", stringify!(tdLC_TLP_CALLBACK))
    );
    assert_eq!(
        ::std::mem::align_of::<tdLC_TLP_CALLBACK>(),
        8usize,
        concat!("Alignment of ", stringify!(tdLC_TLP_CALLBACK))
    );
    assert_eq!(
...
pub type LC_TLP_CALLBACK = tdLC_TLP_CALLBACK;
pub type PLC_TLP_CALLBACK = *mut tdLC_TLP_CALLBACK;
